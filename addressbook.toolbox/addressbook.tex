...
\@y{\@s{0}%
 A different ideom for an empty function\.{\dots}
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Add ( name ,\, email ) \.{\defeq}}%
 \@x{\@s{22.06} address \.{'} \.{=} [ n \.{\in} {\DOMAIN} address \.{\cup} \{
 name \} \.{\mapsto}}%
\@x{\@s{105.64} {\IF} n \.{\in} {\DOMAIN} address}%
\@x{\@s{105.64} \.{\THEN} address [ n ]}%
\@x{\@s{105.64} \.{\ELSE} email}%
\@x{\@s{70.84} ]}%
\@pvspace{8.0pt}%
\@x{ Remove ( name ) \.{\defeq}}%
...
\@pvspace{8.0pt}%
\@x{ Find ( name ) \.{\defeq}}%
\@x{\@s{21.36} \.{\land} name \.{\in} {\DOMAIN} address}%
\@x{\@s{21.36} \.{\land} {\UNCHANGED} address}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \E\, n \.{\in} Names ,\, e \.{\in} Emails \.{:}}%
\@x{\@s{27.72} \.{\lor} Add ( n ,\, e )}%
\@x{\@s{27.72} \.{\lor} Remove ( n )}%
\@x{\@s{27.72} \.{\lor} Find ( n )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 12 21:15:28 \ensuremath{GMT} 2021 by \ensuremath{alunm
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Feb} 10
 21:49:46 \ensuremath{GMT} 2021 by \ensuremath{alunm
}%
\end{cpar}%
\end{lcom}%
\end{document}
